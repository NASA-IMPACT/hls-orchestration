...
from lambda_functions.landsat_mgrs_logger.hls_landsat_mgrs_logger.handler import handler


@patch(
    "lambda_functions.landsat_mgrs_logger.hls_landsat_mgrs_logger.handler.rds_client"
)
