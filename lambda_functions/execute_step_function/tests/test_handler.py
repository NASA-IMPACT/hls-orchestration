...
from lambda_functions.execute_step_function.hls_execute_step_function.handler import handler
...
@patch("lambda_functions.execute_step_function.hls_execute_step_function.handler.boto3.client")
